...
.hdr-title {
  ...
  font-size: 28px; font-weight: 500; color: #FDF8F0; letter-spacing: 3px; line-height: 1.1;
}
.hdr-title span { color: #DEB85A; }
.hdr-title-hi {
  font-family: 'Noto Serif Devanagari', serif;
  font-size: 19px; color: rgba(222,184,90,.8); letter-spacing: 1px; margin-top: 2px;
}
.hdr-desc {
  font-size: 12px; color: rgba(253,248,240,.4);
...
.hdr-samvat {
  font-family: 'Cinzel', serif;
  font-size: 11px; letter-spacing: 2px; color: rgba(222,184,90,.5); margin-bottom: 1px;
}
.hdr-samvat-num {
  font-family: 'Cinzel', serif;
  font-size: 22px; color: rgba(222,184,90,.85); line-height: 1.1;
}
.hdr-date { font-size: 13px; color: rgba(253,248,240,.45); margin-top: 3px; }
...
.sec-head {
  font-family: 'Cinzel', serif;
  font-size: 22px; font-weight: 500; color: var(--walnut);
...
.subsec {
  font-family: 'Cinzel', serif;
  font-size: 13px; letter-spacing: 2px; color: var(--walnut-mid);
  margin: 20px 0 12px; padding-bottom: 8px;
  border-bottom: 1px solid var(--border);
  display: flex; align-items: center; gap: 8px;
}
.subsec .deva { font-family: 'Noto Serif Devanagari', serif; font-size: 13px; color: var(--muted); opacity: .75; }
...
.pc-lbl {
  font-family: 'Cinzel', serif;
  font-size: 9px; letter-spacing: 2px; color: var(--saffron);
  display: block; margin-bottom: 3px; text-transform: uppercase;
}
.pc-lbl-deva {
  font-family: 'Noto Serif Devanagari', serif;
  font-size: 11px; color: var(--muted); display: block; margin-bottom: 5px; opacity: .75;
}
.pc-val {
  font-size: 19px; font-weight: 500; color: var(--walnut); line-height: 1.3;
}
.pc-val-big {
  font-family: 'Cinzel', serif; font-size: 21px; font-weight: 500; color: var(--walnut);
}
.pc-sub { font-size: 13px; color: var(--muted); margin-top: 3px; }
...
.muh-deva { font-family: 'Noto Serif Devanagari', serif; font-size: 12px; color: var(--walnut-mid); opacity: .75; }
.muh-time { font-size: 20px; color: var(--walnut); font-weight: 500; }
.muh-note { font-size: 13px; color: var(--muted); margin-top: 2px; }

/* ── PLANET TABLE ── */
.planet-tbl { width: 100%; border-collapse: collapse; font-size: 15px; }
.planet-tbl th {
...
.ic-body { font-size: 16px; line-height: 1.75; color: var(--ink); }
.ic-accent { display: inline-block; margin-top: 8px; font-size: 14px; color: var(--saffron); font-style: italic; }
...
.bday-yr { font-family: 'Cinzel', serif; font-size: 12px; letter-spacing: 2px; color: var(--muted); margin-bottom: 4px; }
.bday-date { font-size: 22px; font-weight: 500; color: var(--walnut); margin-bottom: 3px; }
.bday-deva { font-family: 'Noto Serif Devanagari', serif; font-size: 15px; color: var(--muted); margin-bottom: 10px; }
.bday-detail { font-size: 15px; color: var(--muted); line-height: 1.9; }
...
.guna-name {
  font-family: 'Cinzel', serif; font-size: 11px; letter-spacing: 1px;
  color: var(--muted); min-width: 110px; text-transform: uppercase;
}
.guna-pts { font-size: 19px; font-weight: 500; min-width: 55px; color: var(--walnut); }
.guna-status { font-size: 15px; color: var(--ink); flex: 1; }
...
.score-num { font-family: 'Cinzel Decorative', serif; font-size: 2.6rem; line-height: 1; }
.score-den { font-size: 1rem; opacity: .6; }
.score-rec { font-family: 'Cinzel', serif; font-size: 12px; letter-spacing: 1px; margin-top: 8px; }
.score-bar {
...
.lin-icon { font-size: 22px; width: 28px; flex-shrink: 0; }
.lin-lbl {
  font-family: 'Cinzel', serif; font-size: 9px; letter-spacing: 1.5px;
  color: var(--saffron); text-transform: uppercase; margin-bottom: 3px;
}
.lin-val { font-size: 19px; font-weight: 500; color: var(--walnut); }
.lin-desc { font-size: 14px; color: var(--muted); font-style: italic; margin-top: 3px; }
...
.ai-box::before {
  ...
  font-family: 'Cinzel', serif; font-size: 11px; letter-spacing: 3px; color: rgba(222,184,90,.4);
}
.ai-lbl {
...
.stMetric label { font-family:'Cinzel',serif !important; font-size:11px !important; color:var(--muted) !important; letter-spacing:1.5px !important; }
.stMetric [data-testid="stMetricValue"] { font-size:1.25rem !important; color:var(--walnut) !important; }
...
.styled-div span { font-family:'Cinzel',serif; font-size:11px; letter-spacing:3px; white-space:nowrap; }
...
/* ── FULL YEAR JANTRI BUTTON — gold-saffron accent ── */
div[data-testid="stButton"]:has(button[key="pan_fullcal"]) > button,
div[data-testid="stButton"] button[data-testid="pan_fullcal"] {
  background: linear-gradient(135deg, #B8862A, #D4722A) !important;
  border-color: rgba(184,134,42,.8) !important;
  color: #FDF8F0 !important;
}
div[data-testid="stButton"]:has(button[key="pan_fullcal"]) > button:hover,
div[data-testid="stButton"] button[data-testid="pan_fullcal"]:hover {
  background: linear-gradient(135deg, #D4722A, #E8956A) !important;
  border-color: #DEB85A !important;
}
/* ── Align button columns to bottom so labels + buttons line up ── */
div[data-testid="stHorizontalBlock"] > div[data-testid="stColumn"]:nth-child(6),
div[data-testid="stHorizontalBlock"] > div[data-testid="stColumn"]:nth-child(7) {
...
def _cached_gunas(b_nak: str, g_nak: str, b_gotra: str, g_gotra: str,
                  b_moon_lon: float = None, g_moon_lon: float = None):
    return match_36_gunas(b_nak, g_nak, b_gotra, g_gotra, b_moon_lon, g_moon_lon)
...
def build_events_card_html(ref_date: date) -> str:
    ...
    if ctx["today"]:
        rows = "".join(
            ...
            'padding:5px 0;border-bottom:1px solid rgba(222,184,90,.08)">'
            '<span style="width:8px;height:8px;border-radius:50%;background:' + fc + ';'
            'flex-shrink:0;margin-top:4px"></span>'
            '<span style="font-size:13px;color:rgba(253,248,240,.95);line-height:1.5">' + fn + '</span>'
            '</div>'
            for fn, fc in ctx["today"]
        )
        parts.append(
            '<div style="background:rgba(212,114,42,.13);border-radius:8px;'
            'padding:10px 12px;margin-bottom:8px;border:1px solid rgba(212,114,42,.25)">'
            '<div style="font-family:Cinzel,serif;font-size:8px;letter-spacing:2px;'
            'color:rgba(212,114,42,.9);margin-bottom:6px"> TODAY\'S EVENTS · आज के कार्यक्रम</div>'
            + rows + '</div>'
        )
    ...
    if ctx["upcoming"]:
        ...
        for days_away, evt_date, evts in ctx["upcoming"]:
            ...
            up_rows += (
                ...
                'padding:5px 0;border-bottom:1px solid rgba(222,184,90,.08)">'
                '<span style="font-family:Cinzel,serif;font-size:10px;color:' + first_color + ';'
                'min-width:60px;flex-shrink:0">' + day_lbl + '</span>'
                '<span style="font-size:11px;color:rgba(253,248,240,.5);min-width:38px;flex-shrink:0">'
                + date_str + '</span>'
                '<span style="font-size:13px;color:rgba(253,248,240,.85);line-height:1.45">'
                + evt_names + '</span>'
                '</div>'
            )
        parts.append(
            '<div style="background:rgba(253,248,240,.04);border-radius:8px;'
            'padding:10px 12px;border:1px solid rgba(184,134,42,.1)">'
            '<div style="font-family:Cinzel,serif;font-size:8px;letter-spacing:2px;'
            'color:rgba(222,184,90,.5);margin-bottom:6px"> UPCOMING EVENTS · आगामी कार्यक्रम</div>'
            + up_rows + '</div>'
        )
...
with tabs[0]:
    ...
    with home_l:
        ...
        <div style="padding: 10px 0 4px">
          ...
          <div style="font-size:16px;color:var(--ink);line-height:2;
          ...
          <div style="font-size:16px;color:var(--ink);line-height:2;margin-bottom:20px">
          ...
          <div style="background:linear-gradient(135deg,var(--saffron-pale),var(--gold-pale));
            ...
            <div style="font-family:'Cinzel',serif;font-size:9px;letter-spacing:2px;
                 color:var(--saffron);margin-bottom:10px">OUR INTENT · हमारा उद्देश्य</div>
            <div style="font-size:16px;color:var(--walnut);line-height:2">
    ...
    with home_r:
        ...
        try:
            ...
            <div style="background:linear-gradient(135deg,#3A2010,#4E2210);
              ...
              <div style="text-align:center;font-size:13px;color:rgba(253,248,240,.5);
                   margin-bottom:12px;border-bottom:1px solid rgba(222,184,90,.1);
                   padding-bottom:10px;font-family:'Cormorant Garamond',serif">
                ...
                <div style="background:rgba(253,248,240,.06);border-radius:8px;padding:10px 12px;
                  ...
                  <div style="display:flex;align-items:flex-start;gap:10px;flex-wrap:wrap">
                    <div style="flex:1;min-width:80px">
                      <div style="font-family:'Cinzel',serif;font-size:8px;letter-spacing:2px;
                           color:rgba(212,114,42,.7);margin-bottom:3px">MĀSA</div>
                      <div style="font-size:19px;font-weight:500;color:#FDF8F0;line-height:1.1">
                        {home_masa_label}</div>
                      <div style="font-family:'Noto Serif Devanagari',serif;font-size:14px;
                           color:rgba(222,184,90,.8);margin-top:2px">
                        {'अधिक ' if home_adhik else ''}{MASA_KOSHUR_DEVA.get(home_p['masa'], home_masa_koshur)}</div>
                      <div style="font-size:11px;color:rgba(253,248,240,.4);margin-top:1px">{home_masa_hi}</div>
                    </div>
                    <div style="color:rgba(222,184,90,.2);font-size:22px;line-height:1;align-self:center">·</div>
                    <div style="flex:1;min-width:80px">
                      <div style="font-family:'Cinzel',serif;font-size:8px;letter-spacing:2px;
                           color:rgba(212,114,42,.7);margin-bottom:3px">TITHI</div>
                      <div style="font-size:19px;font-weight:500;color:#FDF8F0;line-height:1.1">
                      ...
                      <div style="font-size:11px;color:rgba(253,248,240,.4);margin-top:1px">
              ...
              <div style="display:flex;flex-direction:column;gap:6px;margin-top:8px">
                <div style="background:rgba(253,248,240,.06);border-radius:8px;padding:9px 12px">
                  <div style="font-family:'Cinzel',serif;font-size:8px;letter-spacing:2px;
                       color:rgba(212,114,42,.7);margin-bottom:3px">NAKṢATRA · नक्षत्र</div>
                  <div style="font-size:17px;font-weight:500;color:#FDF8F0;line-height:1.2">
                    {home_p['nakshatra']}</div>
                  <div style="font-size:12px;color:rgba(222,184,90,.7);margin-top:2px">
                ...
                <div style="background:rgba(184,134,42,.12);border-radius:8px;padding:9px 12px;
                  ...
                  <div style="font-family:'Cinzel',serif;font-size:8px;letter-spacing:2px;
                       color:#DEB85A;margin-bottom:3px">SUNRISE · SUNSET</div>
                  <div style="font-size:16px;font-weight:500;color:#FDF8F0">
                    {home_p['sunrise']} &nbsp;·&nbsp; {home_p['sunset']}</div>
                </div>
                <div style="background:rgba(184,134,42,.08);border-radius:8px;padding:9px 12px">
                  <div style="font-family:'Cinzel',serif;font-size:8px;letter-spacing:2px;
                       color:rgba(212,114,42,.7);margin-bottom:3px">ABHIJIT MUHŪRTA</div>
                  <div style="font-size:16px;font-weight:500;color:#FDF8F0">
...
with tabs[1]:
    ...
    # ── TOP CONTROL BAR: all inputs horizontal + Full Year button ──
    _ci1, _ci2, _ci3, _ci4, _ci5, _ci6, _ci7 = st.columns([1.4, 1.1, 1.0, 0.55, 0.55, 1.1, 1.1])
    with _ci1:
    ...
    with _ci4:
        p_hour = st.number_input("Hour", min_value=0, max_value=23,
                                  value=12, step=1, key="pan_hr")
    with _ci5:
        p_min  = st.number_input("Min", min_value=0, max_value=59,
                                  value=0, step=1, key="pan_min")
    with _ci6:
        _pan_go = st.button("Calculate Pañcāṅga", key="pan_go", use_container_width=True)
    with _ci7:
        if st.button("📅 Full Year Events · जंतरी", key="pan_fullcal", use_container_width=True):
            st.session_state["pan_show_fullcal"] = not st.session_state.get("pan_show_fullcal", False)

    _use_time = False   # time checkbox removed from sidebar; hour/min always used
    p_time_h = int(p_hour)
    p_time_m = int(p_min)

    # ── Full-year event list (shown/hidden by button) ────────────
    if st.session_state.get("pan_show_fullcal", False):
        # ── Box header: title left, close button right ────────────
        st.markdown("""
        <style>
        /* Close button styling */
        div[data-testid="stButton"]:has(button[key="pan_fullcal_close"]) > button {
            background: rgba(42,122,106,.15) !important;
            border: 1px solid rgba(42,122,106,.5) !important;
        ...
        div[data-testid="stButton"]:has(button[key="pan_fullcal_close"]) > button:hover {
            background: #8B1C30 !important;
            border-color: #8B1C30 !important;
            color: #FDF8F0 !important;
        }
        </style>
        """, unsafe_allow_html=True)

        _fycal_hdr_l, _fycal_hdr_r = st.columns([11, 1])
        with _fycal_hdr_l:
            st.markdown("""
            <div style="background:linear-gradient(135deg,#3A2010,#4E2210);
              ...
              <span style="font-family:'Cinzel',serif;font-size:13px;font-weight:500;
                    letter-spacing:2px;color:#DEB85A"> PŪRṆA VARṢA JANTARĪ · पूर्ण वर्ष जंतरी</span>
              <span style="font-family:'Cormorant Garamond',serif;font-size:11px;
                    color:rgba(222,184,90,.5);letter-spacing:1px">
                KP Jantri Events · All Months</span>
            </div>
            """, unsafe_allow_html=True)
        with _fycal_hdr_r:
            if st.button("✕", key="pan_fullcal_close", use_container_width=True):
                st.session_state["pan_show_fullcal"] = False
                st.rerun()
        ...
        # Build descriptive event list per month
        def _build_month_desc_html(yr, mo):
            mn = _month_names[mo - 1]
            masa_lbl = _masa_for_month.get(mo, "")
            # Collect all event days in this month
            import calendar as _c2
            _, num_days = _c2.monthrange(yr, mo)
            event_rows = ""
            has_any = False
            for day in range(1, num_days + 1):
                ...
                if evts or is_td:
                    has_any = True
                    day_str  = d_obj.strftime("%d %b, %A")
                    today_pill = '<span class="today-pill">TODAY</span>' if is_td else ""
                    evt_items = "".join(
                        f'<span class="evt-chip" style="border-color:{c}55;color:{c}">'
                        f'<span class="evt-dot" style="background:{c}"></span>{e}</span>'
                        for e, c in evts
                    )
                    event_rows += (
                        f'<div class="evt-row">'
                        f'<div class="evt-date">{day_str}{today_pill}</div>'
                        f'<div class="evt-chips">{evt_items}</div>'
                        f'</div>'
                    )
            if not has_any:
                event_rows = '<div class="no-evts">No recorded events this month</div>'
            return (
                f'<div class="month-section" id="mo-{mo}">'
                f'<div class="month-hdr">'
                f'<span class="month-name">{mn} {yr}</span>'
                f'<span class="month-masa">{masa_lbl}</span>'
                f'</div>'
                f'<div class="month-events">{event_rows}</div>'
                f'</div>'
            )

        months_html = "".join(_build_month_desc_html(_fy_year, m) for m in range(1, 13))

        # Pre-build jump-bar outside the f-string to avoid backslash-in-expression error
        _jump_links = []
        for _ji, _jmn in enumerate(_month_names):
            _mo_num  = _ji + 1
            _active  = " active" if _mo_num == today.month else ""
            _onclick = (
                f"document.getElementById('mo-{_mo_num}')"
                f".scrollIntoView({{behavior:'smooth'}});return false;"
            )
            _jump_links.append(
                f'<a class="jump-btn{_active}" href="#mo-{_mo_num}"'
                f' onclick="{_onclick}">{_jmn[:3]}</a>'
            )
        _jump_bar_html = "\n    ".join(_jump_links)
...
<style>
  * {{ box-sizing:border-box; margin:0; padding:0; }}
  body {{ background:#FDF8F0; font-family:'Cormorant Garamond',serif; padding:10px 14px 20px; color:#1E0F06; }}
  #top-bar {{
    display:flex; align-items:center; justify-content:space-between;
  ...
  #top-title {{
    font-family:'Cinzel',serif; font-size:11px; letter-spacing:2px; color:#D4722A;
  }}
  .jump-bar {{ display:flex; flex-wrap:wrap; gap:6px; }}
  .jump-btn {{
    font-family:'Cinzel',serif; font-size:10px; color:#B8862A;
    background:rgba(184,134,42,.1); border:1px solid rgba(184,134,42,.3);
    border-radius:14px; padding:3px 10px; cursor:pointer; text-decoration:none;
    transition:background .15s;
  }}
  .jump-btn:hover, .jump-btn.active {{ background:#3A2010; color:#DEB85A; border-color:#B8862A; }}
  .month-section {{
    margin-bottom:22px;
    border:1px solid rgba(184,134,42,.2);
  ...
  .month-name {{
    font-family:'Cinzel',serif; font-size:16px; font-weight:500; color:#DEB85A;
  }}
  .month-masa {{
    font-family:'Cinzel',serif; font-size:10px; color:rgba(222,184,90,.55);
    letter-spacing:1px;
  }}
  .month-events {{ background:white; padding:10px 14px; }}
  .evt-row {{
    display:flex; align-items:flex-start; gap:14px; flex-wrap:wrap;
    padding:9px 0; border-bottom:1px solid rgba(184,134,42,.12);
  }}
  .evt-row:last-child {{ border-bottom:none; }}
  .evt-date {{
    font-family:'Cinzel',serif; font-size:12px; color:#6B3A1F;
    min-width:160px; flex-shrink:0; padding-top:2px;
  }}
  .today-pill {{
    display:inline-block; margin-left:8px;
    font-size:9px; font-family:'Cinzel',serif; letter-spacing:1px;
    background:#8B1C30; color:#FDF8F0;
    padding:1px 7px; border-radius:10px; vertical-align:middle;
  }}
  .evt-chips {{ display:flex; flex-wrap:wrap; gap:6px; flex:1; }}
  .evt-chip {{
    display:inline-flex; align-items:center; gap:5px;
    font-size:14px; font-family:'Cormorant Garamond',serif;
    padding:3px 10px; border-radius:14px; border:1px solid;
    background:rgba(255,255,255,.6); line-height:1.4;
  }}
  .evt-dot {{
    width:7px; height:7px; border-radius:50%; flex-shrink:0;
  }}
  .no-evts {{
    font-size:13px; color:rgba(106,72,40,.45); font-style:italic; padding:8px 0;
  }}
</style>
</head>
<body>
<div id="top-bar">
  <div id="top-title">VIKRAMA SAṂVAT {_sv_year} &nbsp;·&nbsp; KP JANTRI EVENTS &nbsp;·&nbsp; {_fy_year} CE</div>
  <div class="jump-bar">
    {_jump_bar_html}
  </div>
</div>
{months_html}
        ...
        _stc.html(full_cal_html, height=580, scrolling=True)
    ...
    # ── Two-column layout: panchang card (left) | calendar (right) ──
    left_col, right_col = st.columns([1.4, 2.6])
    ...
    try:
        ...
        with left_col:
            ...
            <div style="background:linear-gradient(135deg,#3A2010,#4E2210);border-radius:14px;
              ...
              <div style="text-align:center;border-bottom:1px solid rgba(222,184,90,.15);
                ...
                <div style="font-family:'Cinzel Decorative',serif;font-size:26px;
                     color:rgba(222,184,90,.9);line-height:1">{sv}</div>
                <div style="font-size:13px;color:rgba(253,248,240,.55);margin-top:3px;
              ...
              <div style="background:rgba(253,248,240,.06);border-radius:10px;
                ...
                <div style="display:flex;align-items:flex-start;gap:10px;flex-wrap:wrap">
                  <div style="flex:1;min-width:80px">
                    ...
                    <div style="font-size:22px;font-weight:500;color:#FDF8F0;line-height:1.1">
                      {masa_full_name}{adhik_pill}</div>
                    <div style="font-family:'Noto Serif Devanagari',serif;font-size:15px;
                         color:rgba(222,184,90,.85);margin-top:3px">
                      {'अधिक ' if is_adhik else ''}{MASA_KOSHUR_DEVA.get(panchang['masa'], masa_koshur)}</div>
                    <div style="font-size:12px;color:rgba(253,248,240,.45);margin-top:1px">{masa_full_hi}</div>
                  </div>
                  ...
                  <div style="flex:1;min-width:80px">
                    ...
                    <div style="font-size:12px;color:rgba(253,248,240,.45);margin-top:1px">
                      {panchang['paksha']} · {panchang['tithi']}</div>
                    <div style="font-size:12px;color:rgba(253,248,240,.35);margin-top:1px">
              ...
              {_pan_events_html}
              <div style="background:rgba(253,248,240,.06);border-radius:8px;padding:10px 12px;
                   border:1px solid rgba(184,134,42,.15);margin-bottom:10px;margin-top:8px">
                <div style="font-family:'Cinzel',serif;font-size:8px;letter-spacing:2px;
                     color:rgba(212,114,42,.7);margin-bottom:4px">NAKṢATRA · नक्षत्र</div>
                <div style="font-size:18px;font-weight:500;color:#FDF8F0;line-height:1.2">
                  {panchang['nakshatra']}</div>
                <div style="font-size:13px;color:rgba(222,184,90,.75);margin-top:2px">
                  Pāda {panchang['nakshatra_pada']}</div>
              </div>
              <div style="background:rgba(184,134,42,.12);border-radius:8px;padding:10px 12px;
                   border:1px solid rgba(184,134,42,.25);margin-bottom:8px">
                <div style="font-family:'Cinzel',serif;font-size:8px;letter-spacing:2px;
                     color:#DEB85A;margin-bottom:4px">ABHIJIT MUHŪRTA</div>
                <div style="font-size:18px;font-weight:500;color:#FDF8F0">
                  {panchang['abhijit_muhurta'][0]} – {panchang['abhijit_muhurta'][1]}</div>
                <div style="font-size:12px;color:rgba(253,248,240,.5);margin-top:2px">
        ...
        with right_col:
            ...
            # Collect panchang + jantri data for every day of the month
            day_data = {}
            probe_d = first_day
            while probe_d <= last_day:
                try:
                    pp = _cached_panchang(probe_d, _p_lat, _p_lon)
                    panch_fests = _FEST_LOOKUP.get(
                        (pp['masa'], pp['paksha'], pp['tithi_num']), []
                    )
                    jantri_evts = get_jantri_events(probe_d)
                    day_data[probe_d] = {
                        'tnum': pp['tithi_num'], 'paksha': pp['paksha'],
                        'nakshatra': pp.get('nakshatra', ''),
                        'yoga': pp.get('yoga', ''),
                        'panch_fests': panch_fests,
                        'jantri': jantri_evts,
                        'all_evts': panch_fests + jantri_evts,
                        'ausp': pp['auspicious'],
                    }
                except Exception:
                    day_data[probe_d] = {
                        'tnum': 0, 'paksha': '', 'nakshatra': '', 'yoga': '',
                        'panch_fests': [], 'jantri': [], 'all_evts': [], 'ausp': True,
                    }
            ...
            wd_cells = "".join(
                ...
                f'padding:6px 2px;text-align:center;background:var(--cream2);'
            ...
            cells = [
                ...
                f'<div style="min-height:70px;background:transparent;'
                f'border-radius:6px"></div></td>'
            ] * first_wd
            ...
            for dn in range(1, last_day.day + 1):
                ...
                all_evts   = dd.get('all_evts', [])
                jantri     = dd.get('jantri', [])
                panch_fests= dd.get('panch_fests', [])
                ausp       = dd.get('ausp', True)
                nakshatra  = dd.get('nakshatra', '')
                is_sel     = (d_obj == _p_date)
                is_td      = (d_obj == today)

                # Cell background / border
                bg  = SEL_CLR if is_sel else (
                      "rgba(184,134,42,.12)" if is_td else (
                      "rgba(192,48,48,.04)" if not ausp else "white"))
                ...
                # Nakshatra — compact italic line
                nak_html = ""
                if nakshatra:
                    nak_c = "#DEB85A" if is_sel else "rgba(106,72,40,.75)"
                    nak_html = (
                        f'<div style="font-size:8px;color:{nak_c};font-style:italic;'
                        f'line-height:1.2;margin-top:1px;white-space:nowrap;'
                        f'overflow:hidden;text-overflow:ellipsis">{nakshatra}</div>'
                    )

                # Event lines — panchang festivals first, then jantri
                evt_lines = ""
                shown = 0
                for fn, fc in panch_fests:
                    if shown >= 2:
                        break
                    fc_use = "#DEB85A" if is_sel else fc
                    evt_lines += (
                        f'<div style="display:flex;align-items:flex-start;gap:3px;'
                        f'margin-top:2px;line-height:1.2">'
                        f'<span style="width:5px;height:5px;border-radius:50%;background:{fc_use};'
                        f'flex-shrink:0;margin-top:2px"></span>'
                        f'<span style="font-size:8.5px;color:{fc_use};'
                        f'overflow:hidden;text-overflow:ellipsis;white-space:nowrap;'
                        f'max-width:100%">{fn}</span></div>'
                    )
                    shown += 1
                for fn, fc in jantri:
                    if shown >= 2:
                    ...
                    shown += 1
                # overflow badge
                total_evts = len(all_evts)
                if total_evts > 2:
                    more_c = "#DEB85A" if is_sel else "var(--muted)"
                    evt_lines += (
                        f'<div style="font-size:8px;color:{more_c};margin-top:2px;'
                        f'font-style:italic">+{total_evts - 2} more</div>'
                    )

                cells.append(
                    f'<td style="padding:2px;vertical-align:top">'
                    f'<div style="background:{bg};border:{brd};border-radius:6px;{shd}'
                    f'padding:5px 4px 4px;min-height:70px;transition:background .12s">'
                    # date number + tithi
                    f'<div style="display:flex;align-items:baseline;gap:3px;margin-bottom:1px">'
                    f'<span style="font-family:Cinzel,serif;font-size:13px;font-weight:500;'
                    f'color:{nc};line-height:1">{dn}</span>'
                    f'<span style="font-size:8.5px;color:{tc};letter-spacing:.2px">{ts}</span>'
                    f'</div>'
                    # nakshatra
                    f'{nak_html}'
                    # events
            ...
            cells += [
                ...
                f'<div style="min-height:70px;background:rgba(253,248,240,.3);'
                f'border-radius:6px;border:1px solid rgba(184,134,42,.06)"></div></td>'
            ] * rem
            ...
            legend_items = [
                ...
                ("Purnima", PU_CLR),
                ("Amavasya", AM_CLR),
                ("Herath / Major KP", "#e53935"),
                ("Navreh / Auspicious", "#4CAF50"),
                ("Zyeth Ashtami / Kheer Bhawani", "#DEB85A"),
                ("Navratri / Dussehra", "#D4722A"),
                ("Diwali / Dhanteras", "#FFD700"),
                ("Ekadashi / Vrat", "#7C4DFF"),
                ("Yatra / Tirth", "#2A7A6A"),
                ("Shaiva / Bhairava", "#8B1C30"),
                ("Sharika / Shakta", "#9C27B0"),
                ("Sankrati / Sun", "#FF9800"),
                ("Kumar Shastee", "#26C6DA"),
            ]
            legend_dots = "".join(
            ...
            # Masa sub-header for the calendar
            _cal_masa_hi = MASA_DEVA.get(panchang['masa'], panchang['masa'])
            _cal_masa_koshur = MASA_KOSHUR.get(panchang['masa'], panchang['masa'])
            _cal_adhik_label = "Adhika " if is_adhik else ""
            _cal_header_sub = (
                f'<div style="font-family:Cinzel,serif;font-size:9px;letter-spacing:1.5px;'
                f'color:var(--saffron);margin-top:3px">'
                f'{_cal_adhik_label}{_cal_masa_koshur}'
                f'<span style="font-family:Noto Serif Devanagari,serif;font-size:10px;'
                f'color:var(--muted);margin-left:8px">'
                f'{"अधिक " if is_adhik else ""}{_cal_masa_hi}</span></div>'
            )

            st.markdown(
                f'<div style="background:var(--cream);border:1.5px solid var(--border);'
                f'border-radius:14px;padding:16px 14px 12px;'
                f'box-shadow:0 4px 16px var(--shadow),0 1px 4px var(--shadow)">'

                # Month + masa header
                f'<div style="text-align:center;margin-bottom:10px;padding-bottom:10px;'
                f'border-bottom:1.5px solid var(--border)">'
                f'<div style="font-family:Cinzel,serif;font-size:13px;font-weight:500;'
                f'letter-spacing:3px;color:var(--walnut-mid)">{month_name.upper()}</div>'
                f'{_cal_header_sub}'
                f'<div style="font-size:8.5px;color:var(--muted);margin-top:4px;'
                f'font-style:italic">Vedic Pañcāṅga · KP Jantri — combined view</div>'
                f'</div>'

                # Calendar grid — no forced min-width, fills column naturally
                f'<div>'
        ...
        if True:
            p_rows = "".join([
                f"""<tr>
                  ...
                  <td>
                    <span style="font-weight:500;font-size:15px">{data['rashi']}</span>
                    <span style="display:block;font-family:'Noto Serif Devanagari',serif;font-size:13px;color:var(--muted);margin-top:2px">{data['rashi_hi']}</span>
                  </td>
                  <td>
                    <span style="font-weight:500;font-size:15px">{data['nakshatra']} (P{data['pada']})</span>
                    <span style="display:block;font-family:'Noto Serif Devanagari',serif;font-size:13px;color:var(--muted);margin-top:2px">{data['nakshatra_hi']} पाद {data['pada']}</span>
                  </td>
                  <td style="font-size:15px;font-variant-numeric:tabular-nums">
                    <span style="font-weight:500">{data['longitude']:.4f}°</span>
                    <span style="display:block;font-size:12px;color:var(--muted);margin-top:2px">{data['degree']:.4f}° in rashi</span>
                    <span style="display:block;font-size:12px;color:var(--muted)">{data.get('nak_degree', 0):.4f}° in nak</span>
                  </td>
                </tr>"""
        ...
        with st.expander(" Kāśmīra Parva · कश्मीरी पर्व — Festivals & Significance"):
            ...
            for title, desc in festivals:
                ...
                <div class="muh-block spec" style="margin-bottom:8px">
                  ...
                  <div style="font-size:15px;color:var(--ink);margin-top:5px;line-height:1.8">{desc}</div>
                </div>
                """, unsafe_allow_html=True)
    ...
    if do_match:
        try:
            ...
            <div class="panch-cell" style="text-align:left;padding:16px 20px">
              ...
              <div class="pc-val-big" style="margin:8px 0;font-size:22px">{b_nak}</div>
              <div style="font-size:15px;color:var(--gold);margin-bottom:5px">Pāda {boy_data.get('nakshatra_pada', boy_data.get('pada', ''))}</div>
            ...
            <div class="panch-cell" style="text-align:left;padding:16px 20px">
              ...
              <div class="pc-val-big" style="margin:8px 0;font-size:22px">{g_nak}</div>
              <div style="font-size:15px;color:var(--gold);margin-bottom:5px">Pāda {girl_data.get('nakshatra_pada', girl_data.get('pada', ''))}</div>
              <div style="font-size:15px;color:var(--muted)">
            ...
            result = _cached_gunas(b_nak, g_nak, b_gotra_v, g_gotra_v,
                                   boy_data.get('moon_lon'), girl_data.get('moon_lon'))
            score = result["total"]
    ...
    def _render_items(items):
        for item in items:
            ...
            <div style="background:white;border:1px solid var(--border);border-radius:10px;
                 padding:18px 22px;margin-bottom:12px;box-shadow:0 1px 6px var(--shadow)">
              <div style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:6px;margin-bottom:6px">
                <div style="flex:1">
                  <span style="font-family:Cinzel,serif;font-size:17px;font-weight:500;
                ...
                <div style="text-align:right;font-size:13px;color:var(--muted);white-space:nowrap">
                  {item['author']} &nbsp;·&nbsp; {item['period']}
                </div>
              </div>
              <div style="font-size:15px;color:var(--ink);line-height:1.8;margin:8px 0 12px">
                {item['desc']}
              </div>
